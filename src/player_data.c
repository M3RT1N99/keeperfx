...
/******************************************************************************/
TbPixel player_path_colours[COLOURS_COUNT]  =     {131, 90, 163, 181,  20,   4, 106,  52,  42, 74};
TbPixel player_room_colours[COLOURS_COUNT]  =     {132, 92, 164, 183,  21, 132, 108,  54,  44, 76};
TbPixel player_flash_colours[COLOURS_COUNT] =     {133, 94, 167, 142,  31,  15, 110,  54,  46, 78};
TbPixel player_highlight_colours[COLOURS_COUNT] = {31, 31, 31, 31, 31, 31, 31, 31, 31, 31};
TbPixel possession_hit_colours[COLOURS_COUNT] =   {133, 89, 167, 141, 31, 31, 110, 54, 46, 78};
